...
class UnitigGraph {
  public:
    ...
    void InitFromSdBG();
    void ComputeSampleDepths(std::vector<SuccinctDBG>& sample_sdbg, const std::string& output_prefix);
    uint32_t size() {
    ...
    uint32_t MergeBubbles(bool permanent_rm, bool careful, FILE *bubble_file, Histgram<int64_t> &hist, float bubble_pop_depth_ratio_threshold = 1);
